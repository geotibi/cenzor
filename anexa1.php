...
$bill_groups = [
    ...
    6 => ['name' => '7. Salarii - Indemnizatie Membrii Comitet', 'pattern' => '%INDEMNIZATIE MEMBRU COMITET%'],
    7 => ['name' => '7. Salarii - Impozite - Bugetul de Stat', 'pattern' => '%BUGETUL DE STAT%'],
    8 => ['name' => '8. Servicii de curățenie - Viomar', 'pattern' => '%VIOMAR%'],
    9 => ['name' => '9. Administrare - Scomet', 'pattern' => '%SCOMET%'],
    10 => ['name' => '10. Service ascensor - Elevator', 'pattern' => '%Elevator%'],
    11 => ['name' => '11. Service interfon - Interada', 'pattern' => '%Interada%'],
    12 => ['name' => '12. Cenzorat', 'pattern' => '%INDEMNIZATIE CENZOR%'],
    13 => ['name' => '12. Cenzorat', 'pattern' => '%INDEMNIZATIE CENZOR%'],
    14 => ['name' => '14. Comision plăți online', 'pattern' => '%INDEMNIZATIE CENZOR%'],
    15 => ['name' => '12. Cenzorat', 'pattern' => '%INDEMNIZATIE CENZOR%'],
